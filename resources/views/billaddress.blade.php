...
@section('content')
    ...
    <div class="regform p-3">
        ...
        <div class="card p-3 shadow">
            <form class="form" id="project_type" method="POST" action="{{ route('user.billaddress') }}">
                @csrf
                <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required id="street_name" class="form-control" name="street_name"
                ...
                <div class="form-group">
                    ...
                    <input type="text" required id="town" class="form-control" name="town"
                        placeholder="Town/City">
                </div>
                <div class="form-group">
                    <label for="country">Country</label>
                    <input type="text" required id="country" class="form-control" name="country" placeholder="Country">
                </div>
                <div class="form-group">
                    <label for="zipcode">Zip Code</label>
                    <input type="text" required id="zipcode" class="form-control" name="zipcode"
                        placeholder="Zip Code">
                </div>
                <div class="form-group">
                    <label for="phone_number">Phone</label>
                    <input type="text" required id="phone_number" name="phone_number" class="form-control"
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-outline-danger" data-bs-dismiss="modal">Save Data</button>
                </div>
            </form>
        </div>
    </div>
