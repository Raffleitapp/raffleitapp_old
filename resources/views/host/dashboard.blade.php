...
@section('contentss')
    ...
    <div class="container">
        ...
        <div class="my-3">
            <div class="row justify-between g-2 gy-3">
                <div class="col-12 col-md-9">
                    <div class="profile-pix flex items-center">
                        <img src="{{ asset('uploads/images/' . $currentUser->image) }}" class="profile-img" alt="">
                ...
                <div class="col-12 col-md-3">
                    <button onclick="location.href='{{ url('user/create_step') }}'" class="host-btn">Host New Raffle</button>
            ...
            <div class="rafle">
                <h5 class="head">Raffles Hosted (Pending raffles)</h5>
                @php
                ...
                <div class="raffle-group">
                    ...
                    <div class="mx-auto raffle-cardz" onclick="location.href='{{ url('raffle-detail/' . $item->state_raffle_hosted) }}'">
                        <div class="img">
                            <img src="{{ asset('uploads/images/'.$item->cover_image) }}" alt="">
                        </div>
                        <div class="text" style="position: relative">
