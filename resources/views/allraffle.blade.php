...
box-shadow: 0px 0px 40px 0px rgba(33, 82, 115, 0.25);
    ...
    <div class="container-fluid md:px-4">
        ...
        <div class="card-itemhj my-3 md:p-3 ">
          ...
          <div class="md:p-4 xl:p-4 sm:p-2 w-100">
