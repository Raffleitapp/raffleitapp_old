            ...
            <div class="side-item">
                ...
                <li class="{{ request()->is('admin/dashboard*') ? 'active' : ( request()->is('admin')  ? 'active' : '')}}">
                    <a href="{{ route('admin.dashboard') }}" class="link-text"><span style="margin: 0 12px 0 0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 30" fill="none">
                                ...
                                <path d="M6.25 26.25H11.25C12.625 26.25 13.75 25.125 13.75 23.75V18.75C13.75 17.375 12.625 16.25 11.25 16.25H6.25C4.875 16.25 3.75 17.375 3.75 18.75V23.75C3.75 25.125 4.875 26.25 6.25 26.25Z" fill="currentColor" />
                                <path d="M16.25 6.25V11.25C16.25 12.625 17.375 13.75 18.75 13.75H23.75C25.125 13.75 26.25 12.625 26.25 11.25V6.25C26.25 4.875 25.125 3.75 23.75 3.75H18.75C17.375 3.75 16.25 4.875 16.25 6.25Z" fill="currentColor" />
                ...
                <li class="{{ request()->is('admin/raffle*') ? 'active' : ''}}"><a class="link-text" href="{{ route('admin.raffle') }}"><span style="margin: 0 12px 0 0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 30" fill="none">
                                <path d="M15 2.5C8.1 2.5 2.5 8.1 2.5 15C2.5 21.9 8.1 27.5 15 27.5C21.9 27.5 27.5 21.9 27.5 15C27.5 8.1 21.9 2.5 15 2.5ZM24.325 11.4L20.85 12.8375C20.2125 11.1375 18.875 9.7875 17.1625 9.1625L18.6 5.6875C21.225 6.6875 23.3125 8.775 24.325 11.4ZM15 18.75C12.925 18.75 11.25 17.075 11.25 15C11.25 12.925 12.925 11.25 15 11.25C17.075 11.25 18.75 12.925 18.75 15C18.75 17.075 17.075 18.75 15 18.75ZM11.4125 5.675L12.875 9.15C11.15 9.775 9.7875 11.1375 9.15 12.8625L5.675 11.4125C6.6875 8.775 8.775 6.6875 11.4125 5.675ZM5.675 18.5875L9.15 17.15C9.7875 18.875 11.1375 20.225 12.8625 20.85L11.4 24.325C8.775 23.3125 6.6875 21.225 5.675 18.5875ZM18.6 24.325L17.1625 20.85C18.875 20.2125 20.225 18.8625 20.85 17.1375L24.325 18.6C23.3125 21.225 21.225 23.3125 18.6 24.325Z" fill="#FDFDFD" />
                            </svg></span> <span>Raffles</span></a></li>
                <li><a class="link-text" href=""><span style="margin: 0 12px 0 0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 30" fill="none">
                                <path d="M18 21V3L15 5L12 3L9 5L6 3V21L9 19.5L12 21L15 19.5L18 21Z" stroke="#FDFDFD" stroke-width="2" stroke-linejoin="round" />
                ...
                <li class="{{ request()->is('admin/admins*') ? 'active' : ''}}">
                    <a href="{{ route('admin.admins') }}" class="link-text" href=""><span style="margin: 0 12px 0 0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 30" fill="none">
                                <circle cx="15" cy="10" r="4" stroke="#FDFDFD" stroke-width="2" stroke-linecap="round" />
                                <path d="M18.8684 9.875C19.2331 9.24337 19.8338 8.78247 20.5382 8.5937C21.2427 8.40494 21.9934 8.50376 22.625 8.86843C23.2566 9.2331 23.7175 9.83375 23.9063 10.5382C24.0951 11.2427 23.9962 11.9934 23.6316 12.625C23.2669 13.2566 22.6662 13.7175 21.9618 13.9063C21.2573 14.0951 20.5066 13.9962 19.875 13.6316C19.2434 13.2669 18.7825 12.6662 18.5937 11.9618C18.4049 11.2573 18.5038 10.5066 18.8684 9.875L18.8684 9.875Z" stroke="#FDFDFD" stroke-width="2" />
                                <path d="M6.36843 9.875C6.7331 9.24337 7.33375 8.78247 8.03825 8.5937C8.74274 8.40494 9.49337 8.50376 10.125 8.86843C10.7566 9.2331 11.2175 9.83375 11.4063 10.5382C11.5951 11.2427 11.4962 11.9934 11.1316 12.625C10.7669 13.2566 10.1662 13.7175 9.46175 13.9063C8.75726 14.0951 8.00663 13.9962 7.375 13.6316C6.74337 13.2669 6.28247 12.6662 6.0937 11.9618C5.90494 11.2573 6.00376 10.5066 6.36843 9.875L6.36843 9.875Z" stroke="#FDFDFD" stroke-width="2" />
                                <path d="M21.1021 22.5L20.1218 22.6974L20.2834 23.5H21.1021V22.5ZM25.9907 21.4L26.9444 21.0993L25.9907 21.4ZM18.4761 18.3882L17.8712 17.5918L16.7147 18.4703L17.9479 19.2373L18.4761 18.3882ZM25.1173 21.5H21.1021V23.5H25.1173V21.5ZM25.0369 21.7008C25.0319 21.6846 25.0273 21.6531 25.0351 21.6148C25.0425 21.5786 25.0578 21.5511 25.0724 21.5332C25.1006 21.4985 25.1241 21.5 25.1173 21.5V23.5C26.2764 23.5 27.3627 22.4258 26.9444 21.0993L25.0369 21.7008ZM21.2501 18.5C23.6003 18.5 24.6028 20.324 25.0369 21.7008L26.9444 21.0993C26.4501 19.5318 24.9971 16.5 21.2501 16.5V18.5ZM19.0809 19.1845C19.6043 18.787 20.297 18.5 21.2501 18.5V16.5C19.8532 16.5 18.7369 16.9343 17.8712 17.5918L19.0809 19.1845ZM17.9479 19.2373C19.333 20.0988 19.8985 21.589 20.1218 22.6974L22.0824 22.3026C21.8154 20.9769 21.0786 18.8292 19.0042 17.539L17.9479 19.2373Z" fill="#FDFDFD" />
                                <path d="M11.5241 18.3881L12.0522 19.2373L13.2855 18.4703L12.1289 17.5918L11.5241 18.3881ZM4.00951 21.4L3.0558 21.0993L3.0558 21.0993L4.00951 21.4ZM8.89805 22.5V23.5H9.71673L9.87837 22.6974L8.89805 22.5ZM8.75013 18.5C9.70313 18.5 10.3959 18.787 10.9192 19.1845L12.1289 17.5918C11.2632 16.9343 10.147 16.5 8.75013 16.5V18.5ZM4.96321 21.7008C5.39735 20.324 6.39985 18.5 8.75013 18.5V16.5C5.00306 16.5 3.55009 19.5318 3.0558 21.0993L4.96321 21.7008ZM4.88289 21.5C4.87604 21.5 4.89952 21.4985 4.9278 21.5332C4.9424 21.5511 4.95771 21.5786 4.96506 21.6148C4.97284 21.6531 4.9683 21.6846 4.96321 21.7008L3.0558 21.0993C2.63749 22.4258 3.72376 23.5 4.88289 23.5V21.5ZM8.89805 21.5H4.88289V23.5H8.89805V21.5ZM9.87837 22.6974C10.1016 21.589 10.6671 20.0988 12.0522 19.2373L10.996 17.539C8.92152 18.8291 8.18472 20.9769 7.91774 22.3026L9.87837 22.6974Z" fill="#FDFDFD" />
                                <path d="M15 17.5C19.6726 17.5 20.8519 20.9933 21.1495 22.7566C21.2414 23.3012 20.8023 23.75 20.25 23.75H9.75C9.19772 23.75 8.75856 23.3012 8.85048 22.7566C9.14812 20.9933 10.3274 17.5 15 17.5Z" stroke="#FDFDFD" stroke-width="2" stroke-linecap="round" />
                            </svg></span> <span>Administrators</span></a>
                </li>

                <li>
                    <a href="{{ url("/logout") }}" class="link-text" href=""><span style="margin: 0 12px 0 0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
